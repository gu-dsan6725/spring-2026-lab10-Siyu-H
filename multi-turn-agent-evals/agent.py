"""
Customer Support Agent for TechGadgets using Strands SDK.

This agent demonstrates:
- Multi-tool customer support agent using Strands SDK
...
def _create_agent() -> Agent:
    """
    Create and configure the Strands customer support agent.

    Returns:
        Configured Agent instance
    """
    logger.info("Creating customer support agent with 5 tools")
...
def main() -> None:
    ...
    print("\n" + "=" * 80)
    print("TechGadgets Customer Support Agent")
    print("=" * 80 + "\n")

    print("Welcome to TechGadgets support! I can help with orders, products, returns, and more.")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ["quit", "exit", "q"]:
                print("\nThank you for contacting TechGadgets support!")
                break
